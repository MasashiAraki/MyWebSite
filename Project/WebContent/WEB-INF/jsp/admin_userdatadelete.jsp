...
<head>
	...
	<title>Admin User Data Delete</title>
...
<body>
	...
	<div class="container">
		<div class="formdata">
			<form>
				<h1 class="h3 mb-3 font-weight-normal">ユーザ情報の削除</h1>

			<div class="form-group row">
				<label for="name" class="col-sm-3 col-form-label">名前</label>
				<div class="col-sm-9">
					<p class="form-control-plaintext">東京都庁</p>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<p class="form-control-plaintext">1638001</p>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<p class="form-control-plaintext">東京都新宿区西新宿２丁目８−１</p>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<p class="form-control-plaintext">tokyo</p>
				</div>
			</div>

				<strong>上記のアカウントを削除します。</strong>
