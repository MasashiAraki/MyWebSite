...
<body>
	...
	<div class="container">
		...
		<div class="row text-center">
			<div class="col-lg-6">
				<a href="index.html" class="btn btn-primary my-4 mx-auto">ショッピングを続ける</a>
			</div>

			<div class="col-lg-6">
				<a href="userdata.html" class="btn btn-secondary my-4 mx-auto">注文履歴へ</a>
			</div>
		</div>
